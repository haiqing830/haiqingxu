...
我是一名博士生，目前就读于佐治亚理工学院（Georgia Institute of Technology），研究方向为人机交互（HCI）。我的导师是 Alex 教授和 Hyunjoo 教授。我硕士毕业于清华大学美术学院（Tsinghua University）

包括合著，我已经发表 10+ 篇学术论文，主要集中于智能干预系统和行为改变技术的研究。
<a href='https://scholar.google.com/citations?user=YOUR_GOOGLE_SCHOLAR_ID'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=引用"></a>。
